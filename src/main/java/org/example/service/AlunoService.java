...
public class AlunoService implements IService<Aluno, Integer> {
    ...
    public Aluno update(Integer id, Aluno entity) {
        ...
        if (optionalAluno.isPresent()) {
            ...
            alunoEncontrado.setNome(entity.getNome());
            alunoEncontrado.setEndereco(entity.getEndereco());
            alunoEncontrado.setTelefone(entity.getTelefone());
            alunoEncontrado.setMatricula(entity.getMatricula());
